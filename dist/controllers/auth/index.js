    ...
    signUp(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const createUserInUser = yield user_1.default.createUserInUser(name, email);
                if (!createUserInUser) {
                ...
                const createNewUserInAuth = yield auth_2.default.createUserInAuth(email, hashedPassword, createUserInUser._id);
